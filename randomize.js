...
*/
  for (var i = 0; i < 500; i++) {
    ...
    var latitude = center[0] + plusOrMinus * radius;
    */
    var longitude = -122.50777245 + (Math.random() * Math.abs(122.50777245 - 122.39516258));
    if (longitude > -122.46502876) {
      var latitude = 37.71777559 + (Math.random() * (37.80205314 - 37.71777559));
    }
    else {
